(function () {
  ...
  const copy = {
    en: {
      ...
      featuredMccSummary: "Käytännön MCC-case study käynnistysehtoihin, laukaisujen näkyvyyteen, takaisinkytkentätarkistuksiin ja kunnossapidolle hyödylliseen moottoritilaan.",
  ...
  const projectCopy = {
      ...
      "smart-conveyor": {
        ...
        outcomes: ["Simuloitu jumin palautus vähensi käyttäjän resetointivaiheita viidestä kahteen.", "Vikojen näkyvyys parani erillisillä tukos-, jumi- ja resetointitiloilla.", "Antuririippuvuudet kartoitettiin niin, että sekvenssipäätökset ovat jäljitettäviä eivätkä vain ajastukseen perustuvia."],
      ...
      "tank-pid": {
        title: "Säiliön PID-ohjauslaboratorio",
        ...
        overview: "Tavoitteena on verrata viritystapoja, näyttää silmukka trendeissä ja yhdistää ohjauspäätökset prosessin käyttäytymiseen ja käyttäjävaikutukseen.",
        why: "Tämä auttoi ymmärtämään ohjauskäyttäytymistä kaavojen mekaanisen käytön sijaan.",
        ...
        outcomes: ["Vertaile rauhallisen ja aggressiivisen virityksen tuloksia.", "Selitä ylitys, asettumisaika ja häiriövaste näytön avulla.", "Muuta raaka käyttäytyminen luettavaksi insinöörimäiseksi case studyksi."],
      ...
      "remote-monitoring-dashboard": {
        ...
        intro: "Valvontakonsepti, jossa signaalien hyödyllisyys on tärkeämpää kuin visuaalinen melu.",
        ...
        nextSteps: ["Luo dashboard-rakenteet.", "Yhdistä valvontanäkymä automaation case studyyn.", "Lisää perustelut jokaiselle näytön osalle."]
      },
      ...
      "quality-inspection-vision-station": {
        ...
        intro: "Konenäön case study tarkastusvirrasta ja jäljitettävästä logiikasta.",
        ...
        technologies: ["Konenäkö", "Tarkastusvirta", "Hylkäyslogiikka", "Käyttöjäpalaute"], skills: ["Työnkulun suunnittelu", "Laatuajattelu", "Jäljitettävyys", "Järjestelmälogiikka"],
      ...
      "smart-energy-metering-system": {
        ...
        summary: "Energiankäytön valvontatutkimus kuormakäyttäytymisestä, raportoinnista ja insinöörille luettavasta kulutustiedosta.",
        intro: "Järjestelmäkonsepti, joka tekee sähkönkäyttötiedosta hyödyllisempää toiminnan kannalta.",
        problem: "Raaka tehotieto on arvokasta vasta, kun se selittää malleja, poikkeamia ja toimintamahdollisuuksia.",
        overview: "Projekti käsittelee sähkönkulutuksen valvontaa, yhteenvetoa ja muuttamista hyödylliseksi insinööritiedoksi.",
      ...
      "virtual-commissioning-project": {
        ...
        why: "Se osoittaa varmennusajattelua sen sijaan, että kaikki heikkoudet löydettäisiin vasta kentällä.",
        visual: "Simulointivirta, vikaskenaariot ja ennen käyttöänottoa tehtävä validointi",
        ...
        outcomes: ["Luo kehys testaukseen ennen käyttöänottoa.", "Mallinna poikkeavat tilanteet ja odotetut vasteet.", "Käytä simulointia insinöörinäyttönä."],
      ...
      "predictive-maintenance-system": {
        ...
        intro: "Projektisuunta, joka yhdistää kunnossapitotaustani dataan perustuvaan insinööripäätöksentekoon.",
        problem: "Kuntodata on hyödyllistä vasta, kun se ohjaa kunnossapitotoimia oikeaan aikaan ja oikealla varmuudella.",
        ...
        technologies: ["Kunnonvalvonta", "Kunnossapitotriggerit", "Analytiikka", "Luotettavuus"], skills: ["Kunnossapitoajattelu", "Valvonta", "Luotettavuus", "Dataan perustuvat päätökset"],
        outcomes: ["Tunnista hyödylliset varhaiset varoitusindikaattorit.", "Muuta signaalit trigger-logiikaksi.", "Muotoile työ toiminnallisesti hyödylliseksi insinöörityöksi."],
